...
class solver():
    ...
    def findZeros(self,v0):
        ...
        assert type(v0)==float or type(v0)==int, "Expected float input"
    ...
    def findVboundary(self,guess,increment=1e-4,maxprecision=1e-10,itermax=10000):
        ...
        assert type(guess)==float or type(guess)==int, "Expected float input"
        assert guess>0, "Expected positive input"
        assert type(increment)==float or type(increment)==int, "Expected float input"
    ...
    def findV0(self,lowerguess,upperguess,dv,maxprecision=1e-10,itermax=10000,xrange=10,urange=5,show=True):
        ...
        assert type(lowerguess)==float or type(lowerguess)==int, "Expected numerical input"
        assert lowerguess>0, "Expected positive input, got %"%lowerguess
        assert type(upperguess)==float or type(upperguess)==int, "Expected float input"
    ...
    def gammaSearch(self,a=10,g0=None,dg=.0025,glim=5/3,lower=1e-10,upper=.9,itermax=100):
        ...
        """
        assert type(a)==int or type(a)==float, "Expected numerical input"
        assert a>0, "Expected positive input"
        assert g0==None or type(g0)==int or type(g0)==float, "Expected numerical input"
        assert g0==None or g0>0, "Expected positive input"
        assert type(dg)==int or type(dg)==float, "Expected numerical input"
        assert type(glim)==int or type(glim)==float, "Expected numerical input"
        assert type(lower)==int or type(lower)==float, "Expected numerical input"
        assert lower>0, "Expected positive input"
        assert type(upper)==int or type(upper)==float, "Expected numerical input"
